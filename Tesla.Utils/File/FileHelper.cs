...
namespace Tesla.Utils
{
    ...
    public class FileHelper
    {
        ...
        /// </summary>
        /// <param name="directoryPath">指定目录的绝对路径</param>        
        public static string[] GetDirectorieList(string directoryPath)
        {
            try
            {
        ...
        public static bool IsEmptyDirectory(string directoryPath)
        {
            ...
            {
                //判断是否存在文件
                string[] fileNames = GetFileList(directoryPath);
                ...
                //判断是否存在文件夹
                string[] directoryNames = GetDirectorieList(directoryPath);
        ...
        public static void Move(string sourceFilePath, string descDirectoryPath)
        {
            ...
            if (IsDirectoryExist(descDirectoryPath))
            {
                //如果目标中存在同名文件,则删除
                if (IsFileExist(descDirectoryPath + "\\" + sourceFileName))
                {
